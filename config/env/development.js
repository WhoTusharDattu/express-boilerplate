...
module.exports = {
    db: {
        uri: process.env.MONGOHQ_URL || process.env.MONGODB_URI || 'mongodb://jZagAFVyTMsNMIBJ:LXdOsaBjeReUOeXO@dev-operations.groupkdiagnostics.biz:27017/BUAAwktPVfZLIWWl',
        options: {},
